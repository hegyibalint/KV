 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.kv.railroadmodel.impl.TrainModelImpl#getTrains <em>Trains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrainModelImpl extends MinimalEObjectImpl.Container implements TrainModel {
	...
	protected EClass eStaticClass() {
		return RailroadModelPackage.Literals.TRAIN_MODEL;
	}
	...
	public EList<Train> getTrains() {
		if (trains == null) {
			trains = new EObjectContainmentEList<Train>(Train.class, this, RailroadModelPackage.TRAIN_MODEL__TRAINS);
		}
		return trains;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RailroadModelPackage.TRAIN_MODEL__TRAINS:
