...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.query.crash pattern,
...
public abstract class CrashMatch extends BasePatternMatch {
  ...
  private CrashMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
   ...
   * 
   */
  public static CrashMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static CrashMatch newMatch(final Train pT1, final Train pT2) {
