...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.query.zeroBetween pattern,
 * to be used in conjunction with {@link ZeroBetweenMatcher}.
 * 
...
public abstract class ZeroBetweenMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private ZeroBetweenMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return ZeroBetweenMatch.parameterNames;
  }
  ...
  @Override
  public ZeroBetweenMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ZeroBetweenMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ZeroBetweenMatch other = (ZeroBetweenMatch) obj;
  ...
  @Override
  public ZeroBetweenQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ZeroBetweenMatch newEmptyMatch() {
   ...
   * 
   */
  public static ZeroBetweenMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static ZeroBetweenMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends ZeroBetweenMatch {
  ...
  private static final class Immutable extends ZeroBetweenMatch {
