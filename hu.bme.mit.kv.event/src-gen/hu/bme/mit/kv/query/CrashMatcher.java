...
import hu.bme.mit.kv.query.util.CrashQuerySpecification;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.kv.query.crash pattern,
...
public class CrashMatcher extends BaseMatcher<CrashMatch> {
   ...
   * 
   */
  public Collection<CrashMatch> getAllMatches(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public CrashMatch getOneArbitraryMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public void forEachMatch(final Train pT1, final Train pT2, final IMatchProcessor<? super CrashMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Train pT1, final Train pT2, final IMatchProcessor<? super CrashMatch> processor) {
   ...
   * 
   */
  public CrashMatch newMatch(final Train pT1, final Train pT2) {
    return CrashMatch.newMatch(pT1, pT2);
  }
   ...
   * 
   */
  public Set<Train> getAllValuesOft1(final CrashMatch partialMatch) {
   ...
   * 
   */
  public Set<Train> getAllValuesOft2(final CrashMatch partialMatch) {
  ...
  protected CrashMatch tupleToMatch(final Tuple t) {
    try {
    	return CrashMatch.newMatch((hu.bme.mit.kv.model.railroadmodel.Train) t.get(POSITION_T1), (hu.bme.mit.kv.model.railroadmodel.Train) t.get(POSITION_T2));
  ...
  protected CrashMatch arrayToMatch(final Object[] match) {
    try {
    	return CrashMatch.newMatch((hu.bme.mit.kv.model.railroadmodel.Train) match[POSITION_T1], (hu.bme.mit.kv.model.railroadmodel.Train) match[POSITION_T2]);
    } catch(ClassCastException e) {
  ...
  protected CrashMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return CrashMatch.newMutableMatch((hu.bme.mit.kv.model.railroadmodel.Train) match[POSITION_T1], (hu.bme.mit.kv.model.railroadmodel.Train) match[POSITION_T2]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
