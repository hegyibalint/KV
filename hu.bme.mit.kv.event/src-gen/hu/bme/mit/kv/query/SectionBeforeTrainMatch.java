...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.query.sectionBeforeTrain pattern,
 * to be used in conjunction with {@link SectionBeforeTrainMatcher}.
 * 
...
public abstract class SectionBeforeTrainMatch extends BasePatternMatch {
  private Train fT;
  ...
  private SectionBeforeTrainMatch(final Train pT, final Section pS) {
    this.fT = pT;
    this.fS = pS;
  }
  ...
  public String patternName() {
    return "hu.bme.mit.kv.query.sectionBeforeTrain";
  }
  
  @Override
  public List<String> parameterNames() {
    return SectionBeforeTrainMatch.parameterNames;
  }
  ...
  @Override
  public SectionBeforeTrainMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SectionBeforeTrainMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SectionBeforeTrainMatch other = (SectionBeforeTrainMatch) obj;
  ...
  @Override
  public SectionBeforeTrainQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SectionBeforeTrainMatch newEmptyMatch() {
   ...
   * 
   */
  public static SectionBeforeTrainMatch newMutableMatch(final Train pT, final Section pS) {
   ...
   * 
   */
  public static SectionBeforeTrainMatch newMatch(final Train pT, final Section pS) {
    return new Immutable(pT, pS);
  }
  
  private static final class Mutable extends SectionBeforeTrainMatch {
  ...
  private static final class Immutable extends SectionBeforeTrainMatch {
