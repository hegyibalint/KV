...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.query.oneBetween pattern,
 * to be used in conjunction with {@link OneBetweenMatcher}.
 * 
...
public abstract class OneBetweenMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private OneBetweenMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return OneBetweenMatch.parameterNames;
  }
  ...
  @Override
  public OneBetweenMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OneBetweenMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OneBetweenMatch other = (OneBetweenMatch) obj;
  ...
  @Override
  public OneBetweenQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OneBetweenMatch newEmptyMatch() {
   ...
   * 
   */
  public static OneBetweenMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static OneBetweenMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends OneBetweenMatch {
  ...
  private static final class Immutable extends OneBetweenMatch {
