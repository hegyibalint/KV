...
/**
 * A match processor tailored for the hu.bme.mit.kv.queries.oneBetween pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class OneBetweenProcessor implements IMatchProcessor<OneBetweenMatch> {
  /**
  ...
  @Override
  public void process(final OneBetweenMatch match) {
