...
/**
 * A match processor tailored for the hu.bme.mit.kv.queries.safe pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class SafeProcessor implements IMatchProcessor<SafeMatch> {
  /**
  ...
  @Override
  public void process(final SafeMatch match) {
