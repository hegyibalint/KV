...
/**
 * A pattern-specific query specification that can instantiate SameSectionMatcher in a type-safe way.
 * 
 * @see SameSectionMatcher
 * @see SameSectionMatch
 * 
 */
@SuppressWarnings("all")
public final class SameSectionQuerySpecification extends BaseGeneratedEMFQuerySpecification<SameSectionMatcher> {
  private SameSectionQuerySpecification() {
   ...
   * 
   */
  public static SameSectionQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected SameSectionMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return SameSectionMatcher.on(engine);
  }
  
  @Override
  public SameSectionMatch newEmptyMatch() {
    return SameSectionMatch.newEmptyMatch();
  }
  
  @Override
  public SameSectionMatch newMatch(final Object... parameters) {
    return SameSectionMatch.newMatch((hu.bme.mit.kv.model.railroadmodel.Train) parameters[0], (hu.bme.mit.kv.model.railroadmodel.Train) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static SameSectionQuerySpecification INSTANCE = make();
    
    public static SameSectionQuerySpecification make() {
      return new SameSectionQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SameSectionQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.kv.queries.sameSection";
    }
