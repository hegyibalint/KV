...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.queries.sameSection pattern,
 * to be used in conjunction with {@link SameSectionMatcher}.
 * 
...
public abstract class SameSectionMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private SameSectionMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("t1".equals(parameterName) ) {
    	this.fT1 = (hu.bme.mit.kv.model.railroadmodel.Train) newValue;
    	return true;
    }
    if ("t2".equals(parameterName) ) {
    	this.fT2 = (hu.bme.mit.kv.model.railroadmodel.Train) newValue;
    	return true;
    }
    return false;
  }
  ...
  public List<String> parameterNames() {
    return SameSectionMatch.parameterNames;
  }
  ...
  @Override
  public SameSectionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SameSectionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SameSectionMatch other = (SameSectionMatch) obj;
  ...
  @Override
  public SameSectionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SameSectionMatch newEmptyMatch() {
   ...
   * 
   */
  public static SameSectionMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static SameSectionMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends SameSectionMatch {
  ...
  private static final class Immutable extends SameSectionMatch {
