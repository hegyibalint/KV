...
/**
 * Pattern-specific match representation of the hu.bme.mit.kv.queries.safe pattern,
 * to be used in conjunction with {@link SafeMatcher}.
 * 
...
public abstract class SafeMatch extends BasePatternMatch {
  private Train fT1;
  ...
  private SafeMatch(final Train pT1, final Train pT2) {
    this.fT1 = pT1;
    this.fT2 = pT2;
  }
  ...
  public List<String> parameterNames() {
    return SafeMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SafeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public SafeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SafeMatch newEmptyMatch() {
   ...
   * 
   */
  public static SafeMatch newMutableMatch(final Train pT1, final Train pT2) {
   ...
   * 
   */
  public static SafeMatch newMatch(final Train pT1, final Train pT2) {
    return new Immutable(pT1, pT2);
  }
  
  private static final class Mutable extends SafeMatch {
  ...
  private static final class Immutable extends SafeMatch {
